...
function Products({ products }) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) { 
        ...
        await axios.delete(
          `https://sneakers-paradise-back-production.up.railway.app/shoes/${products._id}`
        );
      Swal.fire(
        'Deleted!',
...
const handleOnSale = async()=>{
  const { data } = await axios.put(
    `https://sneakers-paradise-back-production.up.railway.app/admin/onsale/${products._id}`,
    {
